...
{    
	...
	var className="cn.myapps.core.dynaform.form.ejb.GenericWordField";
	var id=getFieldId();	
	oActiveEl = CreateNamedElement( oEditor, oActiveEl, 'img', {
									classname: className,
									src:"images/genericwordfield.gif",
									id: id,
									type:"genericwordfield",
