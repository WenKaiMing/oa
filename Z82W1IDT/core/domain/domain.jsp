...
function change(display) {
	...
	document.getElementsByName('btnWeixinConfig')[0].className = "btcaption";
...
//	document.getElementsByName('btnNetworkDisk')[0].className = "btcaption";
	...
	switch (display.name){ 
		...
		case "btnWeixinConfig": frames["frame"].location.href="<s:url value='/core/domain/configureWeixin.action'/>?domain=<%=request.getParameter("id") %>";break;
...
<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
	<tr valign="top" style="height:27px;">
			...
			<table cellpadding="0" border="0" cellspacing="0" width="100%">
				...
				<div class="listContent nav-seperate"><img src="<s:url value='/resource/imgv2/back/main/nav_seperate.gif' />" /></div>
				<div class="listContent"><input type="button"  name="btnWeixinConfig" class="btcaption" onClick="change(this)" value="{*[微信配置]*}"/></div>
				<div class="listContent nav-seperate"><img src="<s:url value='/resource/imgv2/back/main/nav_seperate.gif' />" /></div>
