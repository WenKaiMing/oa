...
(function($){
	...
	function _init(t){
		...
		if(v.length<=0){//值为空，且可编辑状态下
			panel = $('<div style="height: 128px;width: 128px;background:url(../../H5/resource/component/weixinGpsField/gps.png) 0 0 no-repeat;"></div>');
			...
			panel = $('<div id="weixingpsfield_map_container_'+options.id+'" style="'+display+'width: 128px;text-align: center;">'
					+'<div><img src="../../H5/resource/component/weixinGpsField/gps_ok.png"></div>'
	...
	**/
	function showAddressMap(t) {
		var url = contextPath + '/portal/H5/resource/component/weixinGpsField/view.jsp';
		OBPM.dialog.show({
			width: 682,
			height: 500,
			url: url,
