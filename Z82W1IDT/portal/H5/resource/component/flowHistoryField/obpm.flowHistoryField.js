...
(function($){
	...
	function buildFlowHistoryTextList($field){
		...
		var html = [];
		html.push("<div class='field-title'>" + discript + "</div><table class='component-flowhistory' cellSpacing='0' cellPadding='1' width='100%' align='center' style='border:solid #cccccc;border-width:1px 0px 0px 1px;'><tbody>");
		...
		$field.find("table tr").each(function(i){//行<tr>
			...
			if(i==0){//列头
				...
				$trField.children().each(function(){
					...
					html.push("<div style='margin:0px;padding:0px;border:0px;word-wrap:break-word; word-break:break-all;white-space:pre-wrap;text-align:left;'>");
	...
	$.fn.obpmFlowHistoryField = function(){
		return this.each(function(){
			...
			var html = [];
			html.push("<div name='" + name + "' style='list-style-type:none;margin-left: 3px;margin-right: 3px;margin-top: 3px;margin-bottom: 3px;'>");
