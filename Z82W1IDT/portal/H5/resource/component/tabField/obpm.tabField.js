(function($){
	$.fn.obpmTabNormalField =function(){
		return this.each(function(){
			...
			$field.attr("moduleType","TabNormalHasRefactor");
			...
			$field.find("#tabcontainer > div").each(function(){
                ...
                if(jQuery(this).find(">span>input[moduleType='IncludedView']").size()<=0){
                    jQuery(this).html('<div style="background: #f6f7fb;padding: 15px;border:1px solid #dddddd;">'
						+ '<div style="background-color:#fff;">'+jQuery(this).html()+'</div>'+ '</div>');
                }
			});
