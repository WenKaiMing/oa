(function($) {
		...
		if (jQuery.trim(fileFullName) !="" ) {
			...
			for ( var i = 0; i < str.length; i++) {
				...
				tohtml += '<a title="'+ info2.showName +'" href=' + info2.url + ' target="_blank" style="margin-top:2px;white-space:nowrap;text-decoration: none" >'
						...
						+ '>';
				if (!readonly) {
					tohtml += '<img  border="0" src="../../resource/images/close.gif"/>';
				}
				tohtml += '</a><br/>';
			}
	...
	function refreshFMImageListSub(fileFullName, uploadListId, myheigh, mywidth, readonly, refresh, subGridView) {
		...
		if (jQuery.trim(fileFullName) !="") {
			...
			divContent += '<li  title="" id="' + uploadListId
					...
					+ '</li>';
			divContent += '<li><img title="" type="previous" src="../../resource/images/previous.png" '
			+ '/></li>';
			divContent += '<li><img title="" type="next" src="../../resource/images/next.png"/></li><li>';
			if (!readonly) {
				divContent += '<a href=# type="delete"'
						+ '>' + '<img  border="0" src="../../resource/images/close.gif"/>' + '</a>';
			}
	...
	$.fn.obpmViewFileManager = function(){
		return this.each(function(){
			...
			html += " <li><img title='' type='previous' src='../../resource/images/previous.png' /></li>";
			html += " <li><img title='' type='next' src='../../resource/images/next.png'/></li>";
			html += "</ul></div>";
			var $html=$(html);
