	...
	$.fn.obpmCheckbox = function(){
			return this.each(function(){
				...
				//if(displayType != PermissionType_HIDDEN){
					...
					html +="<span id='" + id + "' fieldType='"+fieldType+"' data-label='" + name + "'  name='span_" + name + "' discript='"+discript+"' isCommonFilter='"+isCommonFilter+"' style='white-space: pre-wrap;'>";
					...
					$field.find("span").each(function(){
						...
						divHtml +=">";
						divHtml +="<span class='obpm-checkbox-text'";
						if(displayType == PermissionType_HIDDEN){
