...
(function($){
	...
	function _init(t){
		...
		var panel = $('<div name="' + options.name + '" id="flowReminderHistoryField_container_'+options.id+'" style="list-style-type:none;margin-left: 3px;margin-right: 3px;margin-top: 3px;margin-bottom: 3px;"></div>');
	...
	function _buildHistoryTableHTML(t){
		...
		var html = [];
		html.push("<div class='field-title'>" + discript + "</div><table cellSpacing='0' cellPadding='1' width='100%' align='center' style='border:solid #cccccc;border-width:1px 0px 0px 1px;'><tbody>");
