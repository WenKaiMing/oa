...
<!-- 输出软件ids，重构使用 -->
<div id="appList" style="display:none" _type="pending" _actionType="Pending">
	<%
...
<script type="text/html" id="tempFlowAccordion">
	...
	<div class="panel">
		...
		<div class="flow-collapse collapse" role="tabpanel">
			<ul class="list-group">
				{{each value.pendingFlowList as flowList}}
...
<script type="text/html" id="tempTbody_tr">
	...
	<tr class="tbody_tr" _url={{value._url}} id="{{value.docId}}">
		<td>
			<div class="tdFace">
				{{value.avatar}}
				<span class="{{if value.read }}isread {{else}} noread{{/if}}"></span>
				{{if value.isAgent }}<span class="isagent">代</span>{{/if}}
			</div>
