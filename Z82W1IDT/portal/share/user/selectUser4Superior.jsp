	...
	<div class="contentDiv on">
		...
		<div id="right" class="crossULdivright">
			...
			<div class="crossULdivright_lef">
				...
				<div id="rightcontent" style="clear: all;padding-top: 5px;"></div>
			</div>
			<div class="guide"></div>
			<div class="crossULdivright_rig">
				
				<div class="list_div list_div_head">{*[cn.myapps.core.email.write.choose.delete_all.allready_choose_user]*}：</div>
