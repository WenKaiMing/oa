...
<link rel="stylesheet" href="<s:url value='/portal/share/fonts/awesome/font-awesome.min.css'/>" />

<script type="text/javascript" src="<s:url value='/portal/share/script/workflow.status.js'/>"></script>

<script type="text/javascript" src='<s:url value='/portal/share/script/jquery.watermark.js' />'></script>
