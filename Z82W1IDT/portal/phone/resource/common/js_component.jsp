...
<!-- Platform lib -->
<script type="text/javascript" src="<s:url value='/portal/phone/resource/js/jquery-obpm-extend.js'/>"></script>
...
<script type="text/javascript" src='<s:url value="/portal/phone/resource/component/userbox/jquery.userbox.js"/>'></script>
...
<script type="text/javascript" src='<s:url value="/portal/phone/resource/component/flowReminderHistoryField/obpm.flowReminderHistoryField.js"/>'></script>
...
<script type="text/javascript" src="<s:url value='/portal/phone/resource/js/util.js'/>"></script>
<script type="text/javascript" src="<s:url value='/portal/phone/resource/js/list.js'/>"></script>
...
<%@ include file="/portal/phone/dynaform/document/content-tmpl.jsp"%>
