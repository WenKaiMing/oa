<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ include file="/portal/phone/resource/common/include_css.jsp" %>
<%@ include file="/portal/phone/resource/common/include_js.jsp" %>
...
<table id="_toolbar" border="0" width="100%" style="display:none;">
		<tr align="left">
			...
			<img src="<s:url value="/portal/share/images/act/act_4.gif"/>">{*[Save]*}</button>
			</td>
			<s:if test="#usbKeyUtil.isNtkoUsbKeyEnable()">
			<td class="line-position2" align="left">
			  <button type="button" id="btnUsbkeyCfg" title="{*[core.usbkey.ekey.signtool.title]*}" class="justForHelp button-image" onClick="javascript:signtool()"><img src="<s:url value='/portal/share/images/act/act_0.gif'/> ">印章管理</button>
			</td>
			</s:if>
			<td class="line-position2" width="50" valign="top" align="left">
			<button type="button" class="button-class" onClick="doReturn();"><img
				src="<s:url value="/portal/share/images/act/act_8.gif"/>">{*[Close]*}</button>
			</td>
		</tr>
	</table>
