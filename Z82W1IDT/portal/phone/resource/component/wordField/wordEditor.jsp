...
<o:MultiLanguage value="FRONTMULTILANGUAGETAG">
	...
	<table border="0" width="100%" id="actionTr">
		<tr align="left">
			...
			<img style="vertical-align:middle;" src="<s:url value="/portal/share/images/act/act_4.gif"/>">{*[Save]*}</button>
			</td>
			<td class="line-position2">
			<button type="button" class="button-class" style="width:60px;padding:0;" onClick="doReturn();"><img
				style="vertical-align:middle;" src="<s:url value="/portal/share/images/act/act_8.gif"/>">{*[Close]*}</button>
			</td>
		</tr>
	</table>
