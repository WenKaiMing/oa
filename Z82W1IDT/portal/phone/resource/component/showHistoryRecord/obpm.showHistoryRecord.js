		...
		return this.each(function(){
			...
			jQuery("#"+ getName + '_showHisDiv').bind('mouseover',function(e){
				...
				time3 = setTimeout(function(){
					...
					var tooltip = jQuery("<span id='tipsMsgDiv' style='display:none;position:absolute;z-index:100;width:70px;height:22px;line-height:22px;'><span id='showHistory' style='font-size:12px;color:#00f;cursor:pointer;background:#fff;'><img title="+HistoryRecord+" style='vertical-align:middle;' src=" + contextPath + "/portal/share/images/extract_target.gif />"+HistoryRecord+"</span></span>");
