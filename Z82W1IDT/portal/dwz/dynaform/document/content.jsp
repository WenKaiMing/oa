...
<%
	...
	if(doc!=null && doc.getState()!=null){
		workflowType = doc.getState().getWorkflowType();
	}
...
#star p em{color:#f60;display:block;font-style:normal;}
	...
	<s:if test="parentid != null && parentid != ''">
		<body style="padding: 0; margin: 0;height:100%;overflow:auto;background-color:#FFFFFF;">
	</s:if>
	<s:else>
		<body class="body-front front-bgcolor1" style="padding:0; margin:0;height:100%;overflow:auto;background-color:#FFFFFF;">
	</s:else>
			...
			<s:form id='document_content' name='document_content' action="save" method="post" theme="simple">
				<div id="container" class="front-scroll-hidden" style="width: 100%\9;height:100%\9;">
					...
					<s:if test="#request.dochtmlBean.getActivitiesSize()>0">
						<div id="activityTable" class="front-bgcolor2" style="width: 100%;">
										...
										<table id="oLayer" class="table_noborder" style="position: relative;">
											...
											<s:else>
												...
												<td id="flowStateHtml">
													...
													<td class="flowbtn" id="btn-workflow_diagram" style="display: none;">
					...
					<div id="contentTable" class="front-scroll-auto front-boder" style="border-right: 0px; border-left: 0px; width: 100%;*position:relative;/**上传控件的文件不随滚动条滚动兼容ie6、ie7**/">
						<%@include file="/portal/share/common/msg.jsp"%>
						<s:if test="runtimeException.nativeMessage !=null && runtimeException.nativeMessage !=''">	
			<%@include file="/portal/share/common/msgbox/msg.jsp"%>
		</s:if>
						<table class="front-table-full-width" id="toAll" style="z-index: 1;">
							<tr>
