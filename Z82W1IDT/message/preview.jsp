...
<%
	...
	String swfFullPath = contextPath + swfPath + swfFileName;
%>
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <button id="download" class="toolbarButton download hiddenMediumView" title="下载源文件" tabindex="34" data-l10n-id="download">
